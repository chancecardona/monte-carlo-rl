...
def sample_cartpole_params(trial: optuna.Trial) -> Dict[str, Any]:
    ...
    n_evaluation_episodes = 100 - trial.suggest_int("n_evaluation_episodes", 5, 45, log=True)
...
def sample_pixelcopter_params(trial: optuna.Trial) -> Dict[str, Any]:
    ...
    n_evaluation_episodes = 100 - trial.suggest_int("n_evaluation_episodes", 5, 80, log=True)
